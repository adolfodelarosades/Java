...
public class BuscadorStreams extends HttpServlet {
   ...
   protected void service(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
      ...
      items.stream()
         ...
         ) //Convierto el array getSeo() en un Stream y a eso le aplico el anyMatch todo eso es lo que estoy filtrando	          .forEach(item->out.println("<h2><a href='"+item.getUrl()+"'>"+item.getTitulo()+"</a><br/>"));
