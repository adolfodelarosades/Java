...
La vista involucrada es `candidatos.jsp` vamos a recodificarlo con AngularJS es más la vamos a cambiar para que sea un archivo HTML para refreljar aun más los cambios.
