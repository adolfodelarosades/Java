...
Antes desde el Menú llamabamos a 
...
Ahora vamos a llamar directamente a la página HTML
...
La vista involucrada es `candidatos.jsp` vamos a recodificarlo con AngularJS.
