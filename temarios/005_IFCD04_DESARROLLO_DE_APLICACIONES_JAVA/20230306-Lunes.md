...
Como podemos ver en **Maven Runtime** se esta usando el Maven Embebido dentro de Eclipse pero podríamos configurado para usar el Maven instalado en el ordenador si presionamos en **Configure...**
...
Vemos que lo primero que hace con el **`clean install`** es eliminar la carpeta **`target`**
