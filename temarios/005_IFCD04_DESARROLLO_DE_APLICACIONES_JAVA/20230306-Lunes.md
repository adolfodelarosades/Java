...
La **Unidad de Persistencia** se define en un archivo **XML** donde indicamos varios datos entre ellos la conexión a la BD, el ORM que vamos a usar, las Entidades definidas, etc.
