...
1. Instalar y configurar el servidor de aplicaciones
2. Instalar controladores de base de datos
3. Crea una conexión a la base de datos
4. Crear un grupo de conexiones (connection pool)
5. Cree y pruebe su aplicación
6. Implemente su aplicación y sus dependencias (generalmente numerosas) aen el Application Server
